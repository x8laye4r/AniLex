...
> **Important:** This project is still **in active development**.  
> It's my **first major project in C++** and also my **very first desktop app**. I'm learning as I go, feedback is welcome!

> **Note:** Currently only tested on **Linux**.  <br>
> **Windows** will be tested later, but support is be planned. <br>
> **macOS** might never come — I simply have no system to test it on.

> *Disclaimer:*  
> This is my **first major C++ project** and also my **first desktop app**.  
...
If you're not a programmer and have no idea about coding, look here in the Notion [Roadmap](https://www.notion.so/267ba0ec67808074bf0bc81a6f3c8b95?v=267ba0ec678080929917000c91d665ff&source=copy_link)
